...
describe('Dashboard quick start UX', () => {
  it('puts task-oriented next actions at the top of the dashboard', () => {
    ...
    expect(workbench).toContain("import { useTaskDraft }");
    expect(workbench).toContain("draftKey: 'dashboard.workbench.actions.goal.prompt'");
    expect(workbench).toContain("openPendingTask('goal', prompt)");
    expect(workbench).toContain('openChatDraft(prompt)');
    ...
    expect(taskLauncher).toContain("import { useTaskDraft }");
    expect(taskLauncher).toContain("openPendingTask('room', prompt)");
    expect(taskLauncher).toContain('openChatDraft(prompt)');
    ...
    expect(quickStart).toContain("import { useTaskDraft }");
    expect(quickStart).toContain('openChatDraft(t(draftKey))');
