...
export const PANEL_COMMANDS = [
  ...
  {
    id: 'start-direct-chat',
    groupKey: 'controlCenter.group.ai',
    icon: 'chat',
    labelKey: 'controlCenter.action.directChat',
    hint: '/chat · model + tools',
    action: { type: 'route', to: '/chat?new=command' },
  },
  {
    id: 'start-role-room',
    groupKey: 'controlCenter.group.ai',
    icon: 'chatRoom',
    labelKey: 'controlCenter.action.roleRoom',
    hint: '/chat-room · multi-agent',
    action: { type: 'route', to: '/chat-room' },
  },
  {
    id: 'start-scheduled-run',
    groupKey: 'controlCenter.group.ai',
    icon: 'cron',
    labelKey: 'controlCenter.action.scheduledRun',
    hint: '/cron · repeat prompt',
    action: { type: 'route', to: '/cron' },
  },
  {
    id: 'open-external-channels',
    groupKey: 'controlCenter.group.ai',
    icon: 'channels',
    labelKey: 'controlCenter.action.externalChannels',
    hint: '/channels · gateway',
    action: { type: 'route', to: '/channels' },
  },
  {
    id: 'setup-models',
    groupKey: 'controlCenter.group.setup',
    icon: 'settings',
    labelKey: 'controlCenter.action.configureModels',
    hint: 'model.default · providers',
    action: { type: 'route', to: '/settings#providers' },
  },
  {
    id: 'setup-free-local',
    groupKey: 'controlCenter.group.setup',
    icon: 'settings',
    labelKey: 'controlCenter.action.freeLocalModel',
    hint: 'Ollama · localhost',
    action: { type: 'route', to: '/settings#providers' },
  },
  {
    id: 'setup-runtime-health',
    groupKey: 'controlCenter.group.setup',
    icon: 'settings',
    labelKey: 'controlCenter.action.runtimeHealth',
    hint: 'hermes setup · gateway',
    action: { type: 'route', to: '/settings#system-health' },
  },
  {
    id: 'open-cli-parity',
    groupKey: 'controlCenter.group.cli',
    icon: 'developer',
    labelKey: 'controlCenter.action.cliParity',
    hint: 'hermes --help · coverage',
    action: { type: 'route', to: '/developer#cli-parity' },
  },
  {
    id: 'new-chat',
