...
const icons = {
  ...
  templates: 'M4 6h16M4 10h16M4 14h16M4 18h10',
...
const items = computed<MenuItem[]>(() => [
  ...
  { key: 'github', iconPath: icons.github, label: t('nav.github'), path: '/github' },
  { key: 'templates', iconPath: icons.templates, label: t('nav.templates'), path: '/templates' },
  { key: 'plugins', iconPath: icons.plugins, label: t('nav.plugins'), path: '/plugins' },
